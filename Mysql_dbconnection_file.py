...
class mysqlCon:
    ...
    def fndbconn(self):
        ...
        conn = mysqlConnector.connect(
            host='localhost', user='root', password='cool1234', database='PythonWordle')  # We access the connect method through the connector class, which we already import into our program. Now, we are passing our connection parameters to the connect method. The user name and password will be different according to your installation process.
        if conn:
            return 1
        else:
            return 0
