...
from Mysql_dbconnection_file import mysqlCon
...
class RegisterClass(mysqlCon):  # This class is for Registration page.
    def register_user(self):  # Implementing event on register button.
        # Calling fndbConn() from mysqlConn class using Inheritance.
        self.fndbconn()
        ...
        checkUser = mysqlCon.fnRegister(
            self.username_info, self.password_info, self.email_info)
        messagebox.showinfo(
            "Success!", "Welcome! Registration Done Suceessfully..")
        register_screen.destroy()

    def fnUIWordle(self):
        L1 = Label(self.topframe, text="W", font=(
            "Apple, 25"), bg="#8FDE21", width=2)
        L2 = Label(self.topframe, text="O", font=(
            "Apple, 25"), bg="#8FDE21", width=2)
        L3 = Label(self.topframe, text="R", font=(
            "Apple, 25"), bg="#8FDE21", width=2)
        L4 = Label(self.topframe, text="D", font=(
            "Apple, 25"), bg="#8FDE21", width=2)
        L5 = Label(self.topframe, text="L", font=(
            "Apple, 25"), bg="#8FDE21", width=2)
        L6 = Label(self.topframe, text="E", font=(
            "Apple, 25"), bg="#8FDE21", width=2)
    ...
    def register(self):
        ...
        # Calling method of RegisterClass to create UI of "WORDLE" word so no need to repeat this task again and again.
        self.fnUIWordle()
        ...
        self.username_entry = Entry(
            register_screen, textvariable=self.username)
        ...
        self.password_entry = Entry(
            register_screen, textvariable=self.password, show='*')
...
class LoginClass(RegisterClass):
    ...
    def login(self):
        ...
        self.username_login_entry = Entry(
            login_screen, textvariable=self.username_verify)
...
class UserAttemptClass(WordleClass):
    def fnCheckAttemptNo(self):
        ...
        # --- For First attempt ----
        if self.tempCount == 1:
            tmpAnswer = row1e1_entry.get() + row1e2_entry.get() + row1e3_entry.get() + \
                row1e4_entry.get() + row1e5_entry.get()
        ...
        # --- For second attempt ----
            ...
            tmpAnswer = row2e1_entry.get() + row2e2_entry.get() + row2e3_entry.get() + \
                row2e4_entry.get() + row2e5_entry.get()
        ...
        # ----- For third attempt ------
            ...
            tmpAnswer = row3e1_entry.get() + row3e2_entry.get() + row3e3_entry.get() + \
                row3e4_entry.get() + row3e5_entry.get()
        ...
        # Checking for FORTH attempt ----.
            ...
            tmpAnswer = row4e1_entry.get() + row4e2_entry.get() + row4e3_entry.get() + \
                row4e4_entry.get() + row4e5_entry.get()
        ...
        # Checking for FIFTH attempt ----.
            ...
            tmpAnswer = row5e1_entry.get() + row5e2_entry.get() + row5e3_entry.get() + \
                row5e4_entry.get() + row5e5_entry.get()
        ...
        # Checking for SIXTH attempt ----.
            ...
            tmpAnswer = row6e1_entry.get() + row6e2_entry.get() + row6e3_entry.get() + \
                row6e4_entry.get() + row6e5_entry.get()
